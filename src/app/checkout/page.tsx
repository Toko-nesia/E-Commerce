          ...
          <div className="border border-[#511e0b] rounded-[8px] p-5 mt-4 flex items-center relative">
            <div className="bg-[#ececec] border-[#511e0b] border-[0.5px] border-solid rounded-[8px] w-[91px] h-[57px] flex items-center justify-center">
              <div className="relative overflow-hidden h-[19px] w-[69px]">
                <img alt="PayPal" className="absolute h-[183.93%] left-[-0.12%] max-w-none top-[-41.96%] w-[100.24%]" src="/images/PaymentOption/a002559c80637287a6897bcbb94172adeaf103d3.png" />
              </div>
            </div>
        ...
        <div className="w-[500px] bg-[#ececec] p-10 min-h-[calc(100vh-96px)]">
          ...
          <div className="flex gap-4 mt-6">
            <div className="w-[108px] h-[108px] overflow-hidden shrink-0">
              <img alt="Product" className="w-full h-full object-cover" src="/images/CheckOutPage/c08f2321d986609404c2bdb84a34d05860464a4c.png" />
            </div>
            <div>
          ...
          <button onClick={() => router.push("/")} className="w-full bg-[#511e0b] text-white rounded-[8px] h-[58px] mt-6 font-['Inter:Bold',sans-serif] font-bold text-[20px] tracking-[-0.6px] border-none cursor-pointer hover:bg-[#3d1608] transition-colors">
            Pay Now
          </button>
        </div>
      </div>
