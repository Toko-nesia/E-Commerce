    ...
    <PageWrapper>
      <div className="flex max-w-[1200px] mx-auto px-8 py-8 min-h-[800px]">
          ...
          <div className="mt-4 space-y-2">
            {categories.map(c => (
              <Link
                ...
                className="block font-['Inter',sans-serif] text-[16px] tracking-[-0.48px] no-underline text-[#511e0b]"
              >
        ...
        <div className="flex-1 pl-8">
          <h1 className="font-['Inter:Bold',sans-serif] font-bold text-[48px] text-[#511e0b] tracking-[-1.44px]">ALL PRODUCT</h1>
          <div className="flex justify-between items-center mt-4">
            <p className="font-['Inter',sans-serif] text-[15px] text-[#511e0b] tracking-[-0.45px]">Showing 1-9 of 15 product</p>
