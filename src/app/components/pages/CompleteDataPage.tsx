...
import imgElmn32 from "../../../imports/CompleteTheData/fbb1676fb1e714ce082c8512433c9a5517bce894.png";
    ...
    <div className="bg-[#faf5ee] min-h-screen flex items-center justify-center p-4">
      <div className="flex max-w-[906px] w-full shadow-lg">
        ...
        <div className="bg-white flex-1 p-16 flex flex-col justify-center min-h-[675px]">
          <h1 className="font-['Inter:Bold',sans-serif] font-bold text-[24px] text-black">COMPLETE THE DATA</h1>
          <p className="font-['Inter',sans-serif] text-[14px] text-[#605850] mt-1">Complete the data to complete the registration</p>

          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <div>
              <label className="font-['Manrope',sans-serif] text-[11px] text-[#605850] tracking-[1.1px] uppercase">PHONE NUMBER</label>
            ...
            <div>
              <label className="font-['Manrope',sans-serif] text-[11px] text-[#605850] tracking-[1.1px] uppercase">ADDRESS</label>
            ...
            <div className="flex items-start gap-3">
              ...
              <span className="font-['Manrope',sans-serif] text-[12px] text-[#605850]">
                I agree to the <span className="text-[#a24141]">Terms of Service</span> and <span className="text-[#a24141]">Privacy Policy</span>.
              </span>
            </div>
            <div className="flex gap-4">
              <button type="button" onClick={() => navigate(-1)} className="flex-1 bg-[#faf5ee] text-[#511e0b] rounded-[8px] h-[53px] font-['Manrope:Bold',sans-serif] font-bold text-[14px] tracking-[1.4px] uppercase shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] cursor-pointer border-none hover:bg-[#f0e8dc] transition-colors">
                RETURN
              </button>
