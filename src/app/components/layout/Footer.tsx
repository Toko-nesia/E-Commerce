  ...
  return (
    <footer className="relative bg-white border-t border-[#791111] w-full overflow-hidden">
      <div className="absolute inset-0 opacity-80 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[250%] left-0 max-w-none top-[-130%] w-full" src={resolveImagePath("/images/HomeBeforeLogin/d9118e975ef4e144a8e808ccd3a55684c0248095.png")} />
      </div>
